class Solution {
    ...
    public void stackSorting(Stack<Integer> stack1) {
        ...
        while (!stack1.isEmpty()) {
            // Store the sorted size at the begining of the iteration
            int sortedSize = stack2.size();
            ...
            // Transfer unsorted elements from stack2 back to stack1
            while (stack2.size() > sortedSize) {
                int curr = stack2.pop();
                if (curr != min) {
                    stack1.push(curr);
                }
